...
QString GuiFunct::scoGlobalControlStyle(){
    return QString(
        ...
        " background-color: #202020; border-left: 1px solid #555555;"
        ...
        " background-color: #343434; border-left-color: #b76512;"
        "}"
...
QString GuiFunct::scoPanelStyle(){
    return scoGlobalControlStyle() + QString(
        ...
        "QRadioButton::indicator:checked { background-color: #b76512; border-color: #d47a1c; }"
...
QString GuiFunct::scoEditorPanelStyle(){
    ...
    return scoPanelStyle() + QString(
        ...
        "}"
        "QDoubleSpinBox[readOnly=\"false\"]:enabled { border: 1px solid #70590e; }"
        ...
        "}"
        "QDoubleSpinBox[readOnly=\"false\"]:enabled:hover { border: 1px solid #f08200; }"
        ...
        "}"
        "QDoubleSpinBox[readOnly=\"false\"]:enabled:focus { border: 1px solid #8a7116; }"
        ...
        " border: 1px solid #f08200;"
        "}"
        "QDoubleSpinBox[readOnly=\"false\"]:enabled:focus:hover { border: 1px solid #f08200; }"
