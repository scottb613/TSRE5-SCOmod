...
public:
    ...
    bool setTerrainToTrackObj(WorldObj* obj, Brush* brush);
    void smoothTerrainToTrackObj(WorldObj* obj, Brush* brush);
    bool confirmTerrainConformBias(bool roadDatabase);
    ...
    RulerObj* placeGradeRuler(int x, int z, float *p);
    RulerObj* findGradeRuler(bool loadWorldTiles);
    void deleteSpecialRulers();
