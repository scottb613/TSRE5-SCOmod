...
public slots:
    ...
    void clearRecentTextureHistory();
    // brush
...
signals:
    ...
    void mirrorSeasonAccepted();
    void mirrorSeasonError();
...
private:
    ...
    void updateActiveTexturePreviewBorders();
    bool refreshMirrorTexturePreview(bool showBriefErrorIfDisabled = false);
    void showMirrorStatusBriefly(QString text);
    ...
    QLabel* mirrorTexPreviewLabel;
    QLabel* mirrorPairStatus;
    ...
    QPushButton* clearRecentTextures;
    
    QPushButton* colorw;
    QPushButton* mirrorSeason;
    bool mirrorTexturePairReady = false;
    bool mainTexturePreviewReady = false;
